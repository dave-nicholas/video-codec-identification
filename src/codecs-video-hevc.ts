export function getAllHEVCCodecs() {
    const HEVC_PROFILES_DESC = [
        ...
        {
            profile_idc: 9,
            description: 'Screen content coding extensions profiles',
        },
        {
            profile_idc: 10,
            description: 'Scalable format range extensions profile',
        },
    ];

    const HEVC_LEVELS = [10, 20, 21, 30, 31, 40, 41, 50, 51, 52, 60, 61, 62];
    ...
    return [
        {
            ...
            description:
                'HEVC progressive, non-packed stream, Main Profile, Main Tier, Level 3.1',
        },
        {
            codec: 'hev1.2.4.L120.B0',
            description: 'HEVC Main10 Profile, Main Tier, Level 4.0',
        },
        {
            codec: 'hvc1.2.4.L153.90',
            description: 'Codec recommended by google for lowend TV detection',
        },
    ];
}
