export const CODECS = [
    ...
    {
        codec: 'avcp',
        description: 'Advanced Video Coding Parameters',
        type: 'Video',
    },
    ...
    {
        codec: 'dts+',
        description: 'Enhancement layer for DTS layered audio',
        type: 'Audio',
    },
    {
        codec: 'dts-',
        description: 'Dependent base layer for DTS layered audio',
        type: 'Audio',
    },
    {
        codec: 'dtsc',
        description: 'DTS Coherent Acoustics audio',
        type: 'Audio',
    },
    {
        codec: 'dtse',
        description: 'DTS Express low bit rate audio, also known as DTS LBR',
        type: 'Audio',
    },
    {
        codec: 'dtsh',
    ...
    {
        codec: 'encm',
        description: 'Encrypted/Protected metadata stream',
        type: 'Systems',
    },
    ...
    {
        codec: 'g719',
        description: 'ITU-T Recommendation G.719 (2008)',
        type: 'Audio',
    },
    {
        codec: 'g726',
        description: 'ITU-T Recommendation G.726 (1990)',
        type: 'Audio',
    },
    {
        codec: 'hev1',
    ...
    {
        codec: 'ixse',
        description: 'DVB Track Level Index Track',
        type: 'Metadata',
    },
    {
        codec: 'lhv1',
        description: 'Layered High Efficiency Video Coding',
        type: 'Video',
    },
    {
        codec: 'lhe1',
    ...
    {
        codec: 'm2ts',
        description: 'MPEG-2 transport stream for DMB',
        type: 'Hint',
    },
    {
        codec: 'm4ae',
        description: 'MPEG-4 Audio Enhancement MP4v1',
        type: 'Audio',
    },
    {
        codec: 'm4ae',
        description: 'MPEG-4 Audio Enhancement MP4v2',
        type: 'Audio',
    },
    {
        codec: 'mett',
    ...
    {
        codec: 'mha1',
        description: 'MPEG-H Audio (single stream, uncapsulated)',
        type: 'Audio',
    },
    {
        codec: 'mha2',
        description: 'MPEG-H Audio (multi-stream, unencapsulated)',
        type: 'Audio',
    },
    {
        codec: 'mhm1',
        description: 'MPEG-H Audio (single stream, MHAS encapsulated)',
        type: 'Audio',
    },
    {
        codec: 'mhm2',
        description: 'MPEG-H Audio (multi-stream, MHAS encapsulated)',
        type: 'Audio',
    },
    { codec: 'mjp2', description: 'Motion JPEG 2000', type: 'Video' },
    {
        codec: 'mlix',
        description: 'DVB Movie level index track',
        type: 'Metadata',
    },
    ...
    {
        codec: 'rtmd',
        description: 'Real Time Metadata Sample Entry(XAVC Format)',
        type: 'Systems',
    },
    { codec: 'rtp ', description: 'RTP Hints', type: 'Hint' },
    {
        codec: 's263',
        description: 'ITU H.263 video (3GPP format)',
        type: 'Video',
    },
    ...
    {
        codec: 'STGS',
        description: 'Subtitle Sample Entry (HMMP)',
        type: 'Text',
    },
    ...
    {
        codec: 'ulaw',
        description: 'Samples have been compressed using uLaw 2:1.',
        type: 'Audio',
    },
    {
        codec: 'unid',
        description: 'Dynamic Range Control (DRC) data',
        type: 'Metadata',
    },
    {
        codec: 'urim',
